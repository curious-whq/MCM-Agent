...
Task ID: `leaf_abstraction-OptimizationBarrier_EntryData_8-2439c30c60d6746e`
...
- id: `OptimizationBarrier_EntryData_8`
- module: `OptimizationBarrier_EntryData_8`
- kind: `module`
- instance path: `OptimizationBarrier_EntryData_8`
- leaf: `True`
...
```text
[0] FIRRTL:361892 SRC:generators/rocket-chip/src/main/scala/util/package.scala:268:30 KIND:structural :: input clock : Clock
[1] FIRRTL:361893 SRC:generators/rocket-chip/src/main/scala/util/package.scala:268:30 KIND:structural :: input reset : Reset
[2] FIRRTL:361894 SRC:generators/rocket-chip/src/main/scala/util/package.scala:269:18 KIND:structural :: output io : { flip x : { ppn : UInt<20>, u : UInt<1>, g : UInt<1>, ae : UInt<1>, sw : UInt<1>, sx : UInt<1>, sr : UInt<1>, pw : UInt<1>, px : UInt<1>, pr : UInt<1>, pal : UInt<1>, paa : UInt<1>, eff : UInt<1>, c : UInt<1>, fragmented_superpage : UInt<1>}, y : { ppn : UInt<20>, u : UInt<1>, g : UInt<1>, ae : UInt<1>, sw : UInt<1>, sx : UInt<1>, sr : UInt<1>, pw : UInt<1>, px : UInt<1>, pr : UInt<1>, pal : UInt<1>, paa : UInt<1>, eff : UInt<1>, c : UInt<1>, fragmented_superpage : UInt<1>}}
[3] FIRRTL:361896 SRC:generators/rocket-chip/src/main/scala/util/package.scala:273:12 KIND:connect :: connect io.y, io.x
```
