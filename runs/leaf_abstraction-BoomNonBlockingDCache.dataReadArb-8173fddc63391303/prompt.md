...
Task ID: `leaf_abstraction-BoomNonBlockingDCache.dataReadArb-8173fddc63391303`
...
- id: `BoomNonBlockingDCache.dataReadArb`
- module: `Arbiter3_BoomL1DataReadReq`
- kind: `module`
- instance path: `BoomNonBlockingDCache.dataReadArb`
- leaf: `True`
...
- `BoomNonBlockingDCache.dataReadArb::io.in[0].fire`
  ...
  - payload leaves: ['io.in[0].bits.req[0].addr', 'io.in[0].bits.req[0].way_en', 'io.in[0].bits.valid[0]']
  - immediate registers: []
  - historical registers: []
- `BoomNonBlockingDCache.dataReadArb::io.in[1].fire`
  - predicate: `io.in[1].valid && io.in[1].ready`
  - direction/protocol: `receive` / `decoupled`
  - payload leaves: ['io.in[1].bits.req[0].addr', 'io.in[1].bits.req[0].way_en', 'io.in[1].bits.valid[0]']
  - immediate registers: []
  - historical registers: []
- `BoomNonBlockingDCache.dataReadArb::io.in[2].fire`
  - predicate: `io.in[2].valid && io.in[2].ready`
  - direction/protocol: `receive` / `decoupled`
  - payload leaves: ['io.in[2].bits.req[0].addr', 'io.in[2].bits.req[0].way_en', 'io.in[2].bits.valid[0]']
  - immediate registers: []
  - historical registers: []
- `BoomNonBlockingDCache.dataReadArb::io.out.fire`
  - predicate: `io.out.valid && io.out.ready`
  - direction/protocol: `send` / `decoupled`
  - payload leaves: ['io.out.bits.req[0].addr', 'io.out.bits.req[0].way_en', 'io.out.bits.valid[0]']
  - immediate registers: []
  - historical registers: []
...
['io.chosen', 'io.in[0].ready', 'io.in[0].valid', 'io.in[1].ready', 'io.in[1].valid', 'io.in[2].ready', 'io.in[2].valid', 'io.out.bits.req[0].addr', 'io.out.bits.req[0].way_en', 'io.out.bits.valid[0]', 'io.out.ready', 'io.out.valid']
...
```text
[0] FIRRTL:197536 SRC:src/main/scala/chisel3/util/Arbiter.scala:133:7 KIND:structural :: input clock : Clock
[1] FIRRTL:197537 SRC:src/main/scala/chisel3/util/Arbiter.scala:133:7 KIND:structural :: input reset : Reset
[2] FIRRTL:197538 SRC:src/main/scala/chisel3/util/Arbiter.scala:140:14 KIND:structural :: output io : { flip in : { flip ready : UInt<1>, valid : UInt<1>, bits : { req : { way_en : UInt<4>, addr : UInt<12>}[1], valid : UInt<1>[1]}}[3], out : { flip ready : UInt<1>, valid : UInt<1>, bits : { req : { way_en : UInt<4>, addr : UInt<12>}[1], valid : UInt<1>[1]}}, chosen : UInt<2>}
[3] FIRRTL:197540 SRC:src/main/scala/chisel3/util/Arbiter.scala:142:13 KIND:connect :: connect io.chosen, UInt<2>(0h2)
[4] FIRRTL:197541 SRC:src/main/scala/chisel3/util/Arbiter.scala:143:15 KIND:connect :: connect io.out.bits, io.in[2].bits
[5] FIRRTL:197542 SRC:src/main/scala/chisel3/util/Arbiter.scala:145:26 KIND:when :: when io.in[1].valid :
[6] FIRRTL:197543 SRC:src/main/scala/chisel3/util/Arbiter.scala:146:17 KIND:connect :: connect io.chosen, UInt<1>(0h1)
[7] FIRRTL:197544 SRC:src/main/scala/chisel3/util/Arbiter.scala:147:19 KIND:connect :: connect io.out.bits, io.in[1].bits
[8] FIRRTL:197545 SRC:src/main/scala/chisel3/util/Arbiter.scala:145:26 KIND:when :: when io.in[0].valid :
[9] FIRRTL:197546 SRC:src/main/scala/chisel3/util/Arbiter.scala:146:17 KIND:connect :: connect io.chosen, UInt<1>(0h0)
[10] FIRRTL:197547 SRC:src/main/scala/chisel3/util/Arbiter.scala:147:19 KIND:connect :: connect io.out.bits, io.in[0].bits
[11] FIRRTL:197548 SRC:src/main/scala/chisel3/util/Arbiter.scala:45:68 KIND:node :: node _grant_T = or(io.in[0].valid, io.in[1].valid)
[12] FIRRTL:197549 SRC:src/main/scala/chisel3/util/Arbiter.scala:45:78 KIND:node :: node grant_1 = eq(io.in[0].valid, UInt<1>(0h0))
[13] FIRRTL:197550 SRC:src/main/scala/chisel3/util/Arbiter.scala:45:78 KIND:node :: node grant_2 = eq(_grant_T, UInt<1>(0h0))
[14] FIRRTL:197551 SRC:src/main/scala/chisel3/util/Arbiter.scala:153:19 KIND:node :: node _io_in_0_ready_T = and(UInt<1>(0h1), io.out.ready)
[15] FIRRTL:197552 SRC:src/main/scala/chisel3/util/Arbiter.scala:153:14 KIND:connect :: connect io.in[0].ready, _io_in_0_ready_T
[16] FIRRTL:197553 SRC:src/main/scala/chisel3/util/Arbiter.scala:153:19 KIND:node :: node _io_in_1_ready_T = and(grant_1, io.out.ready)
[17] FIRRTL:197554 SRC:src/main/scala/chisel3/util/Arbiter.scala:153:14 KIND:connect :: connect io.in[1].ready, _io_in_1_ready_T
[18] FIRRTL:197555 SRC:src/main/scala/chisel3/util/Arbiter.scala:153:19 KIND:node :: node _io_in_2_ready_T = and(grant_2, io.out.ready)
[19] FIRRTL:197556 SRC:src/main/scala/chisel3/util/Arbiter.scala:153:14 KIND:connect :: connect io.in[2].ready, _io_in_2_ready_T
[20] FIRRTL:197557 SRC:src/main/scala/chisel3/util/Arbiter.scala:154:19 KIND:node :: node _io_out_valid_T = eq(grant_2, UInt<1>(0h0))
[21] FIRRTL:197558 SRC:src/main/scala/chisel3/util/Arbiter.scala:154:31 KIND:node :: node _io_out_valid_T_1 = or(_io_out_valid_T, io.in[2].valid)
[22] FIRRTL:197559 SRC:src/main/scala/chisel3/util/Arbiter.scala:154:16 KIND:connect :: connect io.out.valid, _io_out_valid_T_1
```
