...
Task ID: `leaf_abstraction-LSU-state-0-7-67b23fcaf2455e80`
...
['_T_129', 'will_fire_load_agen[0]', 'will_fire_load_agen_exec[0]', 'will_fire_load_retry[0]', 'will_fire_store_agen[0]', 'will_fire_store_retry[0]']

## Source evidence

### generators/boom/src/main/scala/v4/lsu/lsu.scala:839-842
```scala
    {
...
```text
[2201] FIRRTL:368573 SRC:generators/boom/src/main/scala/v4/lsu/lsu.scala:840:50 KIND:node :: node _T_126 = or(will_fire_load_agen_exec[0], will_fire_load_agen[0])
[2202] FIRRTL:368574 SRC:generators/boom/src/main/scala/v4/lsu/lsu.scala:840:76 KIND:node :: node _T_127 = or(_T_126, will_fire_store_agen[0])
[2203] FIRRTL:368575 SRC:generators/boom/src/main/scala/v4/lsu/lsu.scala:840:103 KIND:node :: node _T_128 = or(_T_127, will_fire_load_retry[0])
[2204] FIRRTL:368576 SRC:generators/boom/src/main/scala/v4/lsu/lsu.scala:841:33 KIND:node :: node _T_129 = or(_T_128, will_fire_store_retry[0])
```
