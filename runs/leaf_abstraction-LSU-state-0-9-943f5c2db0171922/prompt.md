...
Task ID: `leaf_abstraction-LSU-state-0-9-943f5c2db0171922`
...
- raw statements: 7
- logical statements: 5
- mapped/logical source lines: 5
- registers: 1
...
['_T_1092', '_T_1150', 'dis_ld_val', 'h0', 'h1', 'io.core.brupdate.b2.uop.ldq_idx', 'ldq_tail']

## Source evidence

### generators/boom/src/main/scala/v4/lsu/lsu.scala:416-418
```scala
...
### generators/boom/src/main/scala/v4/lsu/lsu.scala:434-436
```scala
...
### generators/boom/src/main/scala/v4/lsu/lsu.scala:1735-1737
```scala
...
### generators/boom/src/main/scala/v4/lsu/lsu.scala:1930-1932
```scala
    ldq_head := 0.U
    ldq_tail := 0.U
```
...
```text
[276] FIRRTL:366648 SRC:generators/boom/src/main/scala/v4/util/util.scala:227:13 KIND:node :: node _T_45 = add(ldq_tail, UInt<1>(0h1))
[277] FIRRTL:366649 SRC:generators/boom/src/main/scala/v4/util/util.scala:227:13 KIND:node :: node _T_46 = tail(_T_45, 1)
[278] FIRRTL:366650 SRC:generators/boom/src/main/scala/v4/util/util.scala:227:18 KIND:node :: node _T_47 = bits(_T_46, 3, 0)
[279] FIRRTL:366651 SRC:generators/boom/src/main/scala/v4/lsu/lsu.scala:417:21 KIND:node :: node _T_48 = mux(dis_ld_val, _T_47, ldq_tail)
[312] FIRRTL:366684 SRC:generators/boom/src/main/scala/v4/lsu/lsu.scala:435:12 KIND:connect :: connect ldq_tail, _T_48
[7874] FIRRTL:374246 SRC:generators/boom/src/main/scala/v4/lsu/lsu.scala:1736:14 KIND:connect :: connect ldq_tail, io.core.brupdate.b2.uop.ldq_idx
[8104] FIRRTL:374476 SRC:generators/boom/src/main/scala/v4/lsu/lsu.scala:1931:14 KIND:connect :: connect ldq_tail, UInt<1>(0h0)
```
