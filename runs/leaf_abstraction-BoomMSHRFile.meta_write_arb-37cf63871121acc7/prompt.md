...
Task ID: `leaf_abstraction-BoomMSHRFile.meta_write_arb-37cf63871121acc7`
Workflow version: `manual-first-workflow-0.9`
Prompt version: `leaf-abstraction-prompt-0.7`
Output schema version: `umcm-formal-0.5`

## WorkUnit

- id: `BoomMSHRFile.meta_write_arb`
- module: `Arbiter2_L1MetaWriteReq`
- kind: `module`
- instance path: `BoomMSHRFile.meta_write_arb`
- leaf: `True`
...
8. Use only formal axiom forms supported by the schema. The language includes
   ...
   and the parts are pairwise mutually exclusive in that cycle. Existing relation axioms may additionally use
...
- `BoomMSHRFile.meta_write_arb::io.in[0].fire`
  ...
  - payload leaves: ['io.in[0].bits.data.coh.state', 'io.in[0].bits.data.tag', 'io.in[0].bits.idx', 'io.in[0].bits.tag', 'io.in[0].bits.way_en']
  - immediate registers: []
  - historical registers: []
- `BoomMSHRFile.meta_write_arb::io.in[1].fire`
  - predicate: `io.in[1].valid && io.in[1].ready`
  - direction/protocol: `receive` / `decoupled`
  - payload leaves: ['io.in[1].bits.data.coh.state', 'io.in[1].bits.data.tag', 'io.in[1].bits.idx', 'io.in[1].bits.tag', 'io.in[1].bits.way_en']
  - immediate registers: []
  - historical registers: []
- `BoomMSHRFile.meta_write_arb::io.out.fire`
  - predicate: `io.out.valid && io.out.ready`
  - direction/protocol: `send` / `decoupled`
  - payload leaves: ['io.out.bits.data.coh.state', 'io.out.bits.data.tag', 'io.out.bits.idx', 'io.out.bits.tag', 'io.out.bits.way_en']
  - immediate registers: []
  - historical registers: []
...
['io.chosen', 'io.in[0].ready', 'io.in[0].valid', 'io.in[1].ready', 'io.in[1].valid', 'io.out.bits.data.coh.state', 'io.out.bits.data.tag', 'io.out.bits.idx', 'io.out.bits.tag', 'io.out.bits.way_en', 'io.out.ready', 'io.out.valid']
...
```text
[0] FIRRTL:188470 SRC:src/main/scala/chisel3/util/Arbiter.scala:133:7 KIND:structural :: input clock : Clock
[1] FIRRTL:188471 SRC:src/main/scala/chisel3/util/Arbiter.scala:133:7 KIND:structural :: input reset : Reset
[2] FIRRTL:188472 SRC:src/main/scala/chisel3/util/Arbiter.scala:140:14 KIND:structural :: output io : { flip in : { flip ready : UInt<1>, valid : UInt<1>, bits : { idx : UInt<6>, way_en : UInt<4>, tag : UInt<20>, data : { coh : { state : UInt<2>}, tag : UInt<20>}}}[2], out : { flip ready : UInt<1>, valid : UInt<1>, bits : { idx : UInt<6>, way_en : UInt<4>, tag : UInt<20>, data : { coh : { state : UInt<2>}, tag : UInt<20>}}}, chosen : UInt<1>}
[3] FIRRTL:188474 SRC:src/main/scala/chisel3/util/Arbiter.scala:142:13 KIND:connect :: connect io.chosen, UInt<1>(0h1)
[4] FIRRTL:188475 SRC:src/main/scala/chisel3/util/Arbiter.scala:143:15 KIND:connect :: connect io.out.bits, io.in[1].bits
[5] FIRRTL:188476 SRC:src/main/scala/chisel3/util/Arbiter.scala:145:26 KIND:when :: when io.in[0].valid :
[6] FIRRTL:188477 SRC:src/main/scala/chisel3/util/Arbiter.scala:146:17 KIND:connect :: connect io.chosen, UInt<1>(0h0)
[7] FIRRTL:188478 SRC:src/main/scala/chisel3/util/Arbiter.scala:147:19 KIND:connect :: connect io.out.bits, io.in[0].bits
[8] FIRRTL:188479 SRC:src/main/scala/chisel3/util/Arbiter.scala:45:78 KIND:node :: node grant_1 = eq(io.in[0].valid, UInt<1>(0h0))
[9] FIRRTL:188480 SRC:src/main/scala/chisel3/util/Arbiter.scala:153:19 KIND:node :: node _io_in_0_ready_T = and(UInt<1>(0h1), io.out.ready)
[10] FIRRTL:188481 SRC:src/main/scala/chisel3/util/Arbiter.scala:153:14 KIND:connect :: connect io.in[0].ready, _io_in_0_ready_T
[11] FIRRTL:188482 SRC:src/main/scala/chisel3/util/Arbiter.scala:153:19 KIND:node :: node _io_in_1_ready_T = and(grant_1, io.out.ready)
[12] FIRRTL:188483 SRC:src/main/scala/chisel3/util/Arbiter.scala:153:14 KIND:connect :: connect io.in[1].ready, _io_in_1_ready_T
[13] FIRRTL:188484 SRC:src/main/scala/chisel3/util/Arbiter.scala:154:19 KIND:node :: node _io_out_valid_T = eq(grant_1, UInt<1>(0h0))
[14] FIRRTL:188485 SRC:src/main/scala/chisel3/util/Arbiter.scala:154:31 KIND:node :: node _io_out_valid_T_1 = or(_io_out_valid_T, io.in[1].valid)
[15] FIRRTL:188486 SRC:src/main/scala/chisel3/util/Arbiter.scala:154:16 KIND:connect :: connect io.out.valid, _io_out_valid_T_1
```
