...
Task ID: `leaf_abstraction-BoomNonBlockingDCache.wbArb-351ef42d13b9ab57`
...
- id: `BoomNonBlockingDCache.wbArb`
- module: `Arbiter2_WritebackReq_1`
- kind: `module`
- instance path: `BoomNonBlockingDCache.wbArb`
- leaf: `True`
...
- `BoomNonBlockingDCache.wbArb::io.in[0].fire`
  ...
  - payload leaves: ['io.in[0].bits.idx', 'io.in[0].bits.param', 'io.in[0].bits.source', 'io.in[0].bits.tag', 'io.in[0].bits.voluntary', 'io.in[0].bits.way_en']
  - immediate registers: []
  - historical registers: []
- `BoomNonBlockingDCache.wbArb::io.in[1].fire`
  - predicate: `io.in[1].valid && io.in[1].ready`
  - direction/protocol: `receive` / `decoupled`
  - payload leaves: ['io.in[1].bits.idx', 'io.in[1].bits.param', 'io.in[1].bits.source', 'io.in[1].bits.tag', 'io.in[1].bits.voluntary', 'io.in[1].bits.way_en']
  - immediate registers: []
  - historical registers: []
- `BoomNonBlockingDCache.wbArb::io.out.fire`
  - predicate: `io.out.valid && io.out.ready`
  - direction/protocol: `send` / `decoupled`
  - payload leaves: ['io.out.bits.idx', 'io.out.bits.param', 'io.out.bits.source', 'io.out.bits.tag', 'io.out.bits.voluntary', 'io.out.bits.way_en']
  - immediate registers: []
  - historical registers: []
...
['io.chosen', 'io.in[0].ready', 'io.in[0].valid', 'io.in[1].ready', 'io.in[1].valid', 'io.out.bits.idx', 'io.out.bits.param', 'io.out.bits.source', 'io.out.bits.tag', 'io.out.bits.voluntary', 'io.out.bits.way_en', 'io.out.ready', 'io.out.valid']
...
```text
[0] FIRRTL:197624 SRC:src/main/scala/chisel3/util/Arbiter.scala:133:7 KIND:structural :: input clock : Clock
[1] FIRRTL:197625 SRC:src/main/scala/chisel3/util/Arbiter.scala:133:7 KIND:structural :: input reset : Reset
[2] FIRRTL:197626 SRC:src/main/scala/chisel3/util/Arbiter.scala:140:14 KIND:structural :: output io : { flip in : { flip ready : UInt<1>, valid : UInt<1>, bits : { tag : UInt<20>, idx : UInt<6>, source : UInt<2>, param : UInt<3>, way_en : UInt<4>, voluntary : UInt<1>}}[2], out : { flip ready : UInt<1>, valid : UInt<1>, bits : { tag : UInt<20>, idx : UInt<6>, source : UInt<2>, param : UInt<3>, way_en : UInt<4>, voluntary : UInt<1>}}, chosen : UInt<1>}
[3] FIRRTL:197628 SRC:src/main/scala/chisel3/util/Arbiter.scala:142:13 KIND:connect :: connect io.chosen, UInt<1>(0h1)
[4] FIRRTL:197629 SRC:src/main/scala/chisel3/util/Arbiter.scala:143:15 KIND:connect :: connect io.out.bits, io.in[1].bits
[5] FIRRTL:197630 SRC:src/main/scala/chisel3/util/Arbiter.scala:145:26 KIND:when :: when io.in[0].valid :
[6] FIRRTL:197631 SRC:src/main/scala/chisel3/util/Arbiter.scala:146:17 KIND:connect :: connect io.chosen, UInt<1>(0h0)
[7] FIRRTL:197632 SRC:src/main/scala/chisel3/util/Arbiter.scala:147:19 KIND:connect :: connect io.out.bits, io.in[0].bits
[8] FIRRTL:197633 SRC:src/main/scala/chisel3/util/Arbiter.scala:45:78 KIND:node :: node grant_1 = eq(io.in[0].valid, UInt<1>(0h0))
[9] FIRRTL:197634 SRC:src/main/scala/chisel3/util/Arbiter.scala:153:19 KIND:node :: node _io_in_0_ready_T = and(UInt<1>(0h1), io.out.ready)
[10] FIRRTL:197635 SRC:src/main/scala/chisel3/util/Arbiter.scala:153:14 KIND:connect :: connect io.in[0].ready, _io_in_0_ready_T
[11] FIRRTL:197636 SRC:src/main/scala/chisel3/util/Arbiter.scala:153:19 KIND:node :: node _io_in_1_ready_T = and(grant_1, io.out.ready)
[12] FIRRTL:197637 SRC:src/main/scala/chisel3/util/Arbiter.scala:153:14 KIND:connect :: connect io.in[1].ready, _io_in_1_ready_T
[13] FIRRTL:197638 SRC:src/main/scala/chisel3/util/Arbiter.scala:154:19 KIND:node :: node _io_out_valid_T = eq(grant_1, UInt<1>(0h0))
[14] FIRRTL:197639 SRC:src/main/scala/chisel3/util/Arbiter.scala:154:31 KIND:node :: node _io_out_valid_T_1 = or(_io_out_valid_T, io.in[1].valid)
[15] FIRRTL:197640 SRC:src/main/scala/chisel3/util/Arbiter.scala:154:16 KIND:connect :: connect io.out.valid, _io_out_valid_T_1
```
