...
Task ID: `leaf_abstraction-BoomNonBlockingDCache.lsu_release_arb-92d18ec47fe4f8de`
...
- id: `BoomNonBlockingDCache.lsu_release_arb`
- module: `Arbiter2_TLBundleC_a32d64s2k3z4c`
- kind: `module`
- instance path: `BoomNonBlockingDCache.lsu_release_arb`
- leaf: `True`
...
- `BoomNonBlockingDCache.lsu_release_arb::io.in[0].fire`
  ...
  - payload leaves: ['io.in[0].bits.address', 'io.in[0].bits.corrupt', 'io.in[0].bits.data', 'io.in[0].bits.opcode', 'io.in[0].bits.param', 'io.in[0].bits.size', 'io.in[0].bits.source']
  - immediate registers: []
  - historical registers: []
- `BoomNonBlockingDCache.lsu_release_arb::io.in[1].fire`
  - predicate: `io.in[1].valid && io.in[1].ready`
  - direction/protocol: `receive` / `decoupled`
  - payload leaves: ['io.in[1].bits.address', 'io.in[1].bits.corrupt', 'io.in[1].bits.data', 'io.in[1].bits.opcode', 'io.in[1].bits.param', 'io.in[1].bits.size', 'io.in[1].bits.source']
  - immediate registers: []
  - historical registers: []
- `BoomNonBlockingDCache.lsu_release_arb::io.out.fire`
  - predicate: `io.out.valid && io.out.ready`
  - direction/protocol: `send` / `decoupled`
  - payload leaves: ['io.out.bits.address', 'io.out.bits.corrupt', 'io.out.bits.data', 'io.out.bits.opcode', 'io.out.bits.param', 'io.out.bits.size', 'io.out.bits.source']
  - immediate registers: []
  - historical registers: []
...
['io.chosen', 'io.in[0].ready', 'io.in[0].valid', 'io.in[1].ready', 'io.in[1].valid', 'io.out.bits.address', 'io.out.bits.corrupt', 'io.out.bits.data', 'io.out.bits.opcode', 'io.out.bits.param', 'io.out.bits.size', 'io.out.bits.source', 'io.out.ready', 'io.out.valid']
...
```text
[0] FIRRTL:197643 SRC:src/main/scala/chisel3/util/Arbiter.scala:133:7 KIND:structural :: input clock : Clock
[1] FIRRTL:197644 SRC:src/main/scala/chisel3/util/Arbiter.scala:133:7 KIND:structural :: input reset : Reset
[2] FIRRTL:197645 SRC:src/main/scala/chisel3/util/Arbiter.scala:140:14 KIND:structural :: output io : { flip in : { flip ready : UInt<1>, valid : UInt<1>, bits : { opcode : UInt<3>, param : UInt<3>, size : UInt<4>, source : UInt<2>, address : UInt<32>, user : { }, echo : { }, data : UInt<64>, corrupt : UInt<1>}}[2], out : { flip ready : UInt<1>, valid : UInt<1>, bits : { opcode : UInt<3>, param : UInt<3>, size : UInt<4>, source : UInt<2>, address : UInt<32>, user : { }, echo : { }, data : UInt<64>, corrupt : UInt<1>}}, chosen : UInt<1>}
[3] FIRRTL:197647 SRC:src/main/scala/chisel3/util/Arbiter.scala:142:13 KIND:connect :: connect io.chosen, UInt<1>(0h1)
[4] FIRRTL:197648 SRC:src/main/scala/chisel3/util/Arbiter.scala:143:15 KIND:connect :: connect io.out.bits, io.in[1].bits
[5] FIRRTL:197649 SRC:src/main/scala/chisel3/util/Arbiter.scala:145:26 KIND:when :: when io.in[0].valid :
[6] FIRRTL:197650 SRC:src/main/scala/chisel3/util/Arbiter.scala:146:17 KIND:connect :: connect io.chosen, UInt<1>(0h0)
[7] FIRRTL:197651 SRC:src/main/scala/chisel3/util/Arbiter.scala:147:19 KIND:connect :: connect io.out.bits, io.in[0].bits
[8] FIRRTL:197652 SRC:src/main/scala/chisel3/util/Arbiter.scala:45:78 KIND:node :: node grant_1 = eq(io.in[0].valid, UInt<1>(0h0))
[9] FIRRTL:197653 SRC:src/main/scala/chisel3/util/Arbiter.scala:153:19 KIND:node :: node _io_in_0_ready_T = and(UInt<1>(0h1), io.out.ready)
[10] FIRRTL:197654 SRC:src/main/scala/chisel3/util/Arbiter.scala:153:14 KIND:connect :: connect io.in[0].ready, _io_in_0_ready_T
[11] FIRRTL:197655 SRC:src/main/scala/chisel3/util/Arbiter.scala:153:19 KIND:node :: node _io_in_1_ready_T = and(grant_1, io.out.ready)
[12] FIRRTL:197656 SRC:src/main/scala/chisel3/util/Arbiter.scala:153:14 KIND:connect :: connect io.in[1].ready, _io_in_1_ready_T
[13] FIRRTL:197657 SRC:src/main/scala/chisel3/util/Arbiter.scala:154:19 KIND:node :: node _io_out_valid_T = eq(grant_1, UInt<1>(0h0))
[14] FIRRTL:197658 SRC:src/main/scala/chisel3/util/Arbiter.scala:154:31 KIND:node :: node _io_out_valid_T_1 = or(_io_out_valid_T, io.in[1].valid)
[15] FIRRTL:197659 SRC:src/main/scala/chisel3/util/Arbiter.scala:154:16 KIND:connect :: connect io.out.valid, _io_out_valid_T_1
```
